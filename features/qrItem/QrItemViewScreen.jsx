...
export default function QrItemViewScreen() {
  ...
  // No unsaved input on this read-only screen — the guard is used purely to
  // route "leaving" (hardware back, swipe, and the visible back button) to
  // the scanner or the list depending on how this screen was reached.
  const { requestLeave: handleBack } = useUnsavedChangesGuard(false, () => {
    if (isFromScan) {
