...
export default function QrItemSuccessScreen() {
  ...
  // No unsaved input on this success screen — the guard is used purely to
  // route "leaving" (hardware back, swipe, and the visible bottom button) to
  // the right place for whichever mode this screen was opened in.
  const { requestLeave: handleBottomButton } = useUnsavedChangesGuard(false, () => {
    if (isViewMode) {
      router.navigate({
